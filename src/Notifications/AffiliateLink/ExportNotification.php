...
namespace Innoboxrr\AffiliateSaas\Notifications\AffiliateLink;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\AffiliateSaas\Exports\AffiliateLinksExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new AffiliateLinksExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | AffiliateLink export notification';
    }
