...
namespace Innoboxrr\AffiliateSaas\Notifications\AffiliateAsset;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\AffiliateSaas\Exports\AffiliateAssetsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new AffiliateAssetsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | AffiliateAsset export notification';
    }
