...
namespace Innoboxrr\AffiliateSaas\Notifications\AffiliateProgram;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\AffiliateSaas\Exports\AffiliateProgramsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new AffiliateProgramsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | AffiliateProgram export notification';
    }
