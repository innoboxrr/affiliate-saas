...
namespace Innoboxrr\AffiliateSaas\Notifications\AffiliatePayout;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\AffiliateSaas\Exports\AffiliatePayoutsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new AffiliatePayoutsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | AffiliatePayout export notification';
    }
