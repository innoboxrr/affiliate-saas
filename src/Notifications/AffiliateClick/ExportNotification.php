...
namespace Innoboxrr\AffiliateSaas\Notifications\AffiliateClick;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\AffiliateSaas\Exports\AffiliateClicksExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new AffiliateClicksExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | AffiliateClick export notification';
    }
