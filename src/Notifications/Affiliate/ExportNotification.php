...
namespace Innoboxrr\AffiliateSaas\Notifications\Affiliate;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\AffiliateSaas\Exports\AffiliatesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new AffiliatesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | Affiliate export notification';
    }
