...
class EventServiceProvider extends ServiceProvider
{
    ...
    {
        $cacheKey = 'aff_events_and_observers';
    ...
    protected function customDiscoverEvents()
    {
        ...
        $namespace = 'Innoboxrr\AffiliateSaas\Http\Events\\';
    ...
    protected function customDiscoverObservers()
    {
        ...
        $namespaceModel = 'Innoboxrr\AffiliateSaas\Models\\';
        $namespaceObserver = 'Innoboxrr\AffiliateSaas\Observers\\';
