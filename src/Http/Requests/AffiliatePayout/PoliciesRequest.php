...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\AffiliateSaas\Models\AffiliatePayout,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? AffiliatePayout::findOrFail($this->id) : app(AffiliatePayout::class);
