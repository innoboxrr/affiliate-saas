...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\AffiliateSaas\Models\AffiliatePayout,id',
    ...
    public function handle()
    {
         ...
         $affiliatePayout = ($this->id) ? 
            AffiliatePayout::findOrFail($this->id) : 
            app(AffiliatePayout::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $affiliatePayout),
        ]);
