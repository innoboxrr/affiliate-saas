...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\AffiliateSaas\Models\AffiliateConversion,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? AffiliateConversion::findOrFail($this->id) : app(AffiliateConversion::class);
