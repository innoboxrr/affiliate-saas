...
use Innoboxrr\AffiliateSaas\Http\Events\AffiliateLink\Events\ForceDeleteEvent;
...
class ForceDeleteRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        return $this->user()->can('forceDelete', $affiliateLink);
    ...
    public function handle()
    {
        ...
        $affiliateLink->forceDeleteModel();

        $response = new AffiliateLinkResource($affiliateLink);

        event(new ForceDeleteEvent($affiliateLink, $this->all(), $response));
