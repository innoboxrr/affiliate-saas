...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\AffiliateSaas\Models\AffiliateLink,id',
    ...
    public function handle()
    {
         ...
         $affiliateLink = ($this->id) ? 
            AffiliateLink::findOrFail($this->id) : 
            app(AffiliateLink::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $affiliateLink),
        ]);
