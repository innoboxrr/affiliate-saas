...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\AffiliateSaas\Models\AffiliateProgram,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? AffiliateProgram::findOrFail($this->id) : app(AffiliateProgram::class);
