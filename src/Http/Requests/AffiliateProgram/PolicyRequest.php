...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\AffiliateSaas\Models\AffiliateProgram,id',
    ...
    public function handle()
    {
         ...
         $affiliateProgram = ($this->id) ? 
            AffiliateProgram::findOrFail($this->id) : 
            app(AffiliateProgram::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $affiliateProgram),
        ]);
