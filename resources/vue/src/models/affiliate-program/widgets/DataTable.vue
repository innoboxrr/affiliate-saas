<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="affiliateProgramExternalFilters"
...
<script>
	...
	import FilterForm from '@affiliatesModels/affiliate-program/forms/FilterForm.vue'
	import * as model from '@affiliatesModels/affiliate-program' 
	...
	export default {
		...
		computed: {
			...
			affiliateProgramExternalFilters() {
