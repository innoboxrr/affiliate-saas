<template>
	...
	<form :id="formId" @submit.prevent="onSubmit">
        ...
        <div class="border rounded-md mb-4">
            ...
            <div v-show="!collapsed.tech" class="p-4 space-y-4">
                ...
                <text-input-component
                    ...
                    label="Monto mínimo para pago"
                    help="Monto mínimo que un afiliado debe alcanzar para poder solicitar un pago"
                    placeholder="Ej. 100"
                    validators="required decimal"
        ...
        <!-- SEGURIDAD -->
        <div class="border rounded-md mb-4">
            <div class="flex justify-between items-center px-4 py-4 border-b bg-gray-50 cursor-pointer" @click="collapsed.security = !collapsed.security">
        ...
        <!-- PÁGINA DE REGISTRO -->
        <div class="border rounded-md mb-4">
            <div class="flex justify-between items-center px-4 py-4 border-b bg-gray-50 cursor-pointer" @click="collapsed.register = !collapsed.register">
                <span class="text-sm font-semibold">
                    Página de Registro
...
export default {
    ...
    methods: {
        ...
        onImageUpload(files) {
            if (files?.[0]?.path) {
                this.affiliateProgram.payload.registration_image = files[0].path
            }
        },
