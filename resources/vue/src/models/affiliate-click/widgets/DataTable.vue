<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="affiliateClickExternalFilters"
...
<script>
	...
	import FilterForm from '@affiliatesModels/affiliate-click/forms/FilterForm.vue'
	import * as model from '@affiliatesModels/affiliate-click' 
