<template>
	...
	<data-table
		title="AffiliateConversion" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="affiliateConversionExternalFilters"
...
<script>
	...
	import FilterForm from '@affiliatesModels/affiliate-conversion/forms/FilterForm.vue'
	import * as model from '@affiliatesModels/affiliate-conversion' 
	...
	export default {
		...
		computed: {
			...
			affiliateConversionExternalFilters() {
