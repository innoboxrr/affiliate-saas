<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="affiliateExternalFilters"
...
<script>
	...
	import FilterForm from '@affiliatesModels/affiliate/forms/FilterForm.vue'
	import * as model from '@affiliatesModels/affiliate' 
